...
export const ChatSidebar = ({ 
  ...
  useEffect(() => {
    ...
    const loadConversations = async () => {
      const conversations: Conversation[] = await chatService.getConversations();
  ...
  const handleRenameSubmit = async (e: React.FormEvent, conversationId: string) => {
    e.preventDefault();
    if (newTitle.trim()) {
